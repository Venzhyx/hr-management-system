...
import { HiOutlineClipboard, HiOutlinePlus } from 'react-icons/hi';
    ...
    <div className="p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Kelola data lembur karyawan</p>
        </div>
        <button
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm">
        <div className="flex flex-col items-center justify-center py-24 px-6 text-center">
          <div className="w-16 h-16 bg-indigo-50 rounded-2xl flex items-center justify-center mb-4">
            <HiOutlineClipboard className="w-8 h-8 text-indigo-400" />
          </div>
          <h3 className="text-base font-semibold text-gray-800 mb-1">
            Belum ada data lembur
          </h3>
          <p className="text-sm text-gray-400 max-w-xs">
            Halaman ini akan menampilkan daftar pengajuan dan rekap lembur karyawan.
          </p>
          <button className="mt-6 flex items-center space-x-2 px-4 py-2 bg-indigo-600 text-white text-sm font-medium rounded-lg hover:bg-indigo-700 transition-colors duration-200">
            <HiOutlinePlus className="w-4 h-4" />
            <span>Tambah Lembur Pertama</span>
          </button>
        </div>
      </div>
    </div>
